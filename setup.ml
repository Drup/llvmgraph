...
(* OASIS_START *)
(* DO NOT EDIT (digest: e22f9b6515584541f8618849ba20c591) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "colordot.ml"});
               Test
                 ({
                     cs_name = "colordot";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "_build";
                      test_run =
                        [
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Llvmgraph";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "M\184<x\rE\160\249\171\201^\163\000&\006\186";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
